{
  ...
  outputs = inputs:
    inputs.parts.lib.mkFlake { inherit inputs; } {
      ...
      imports =
        [ inputs.pre-commit-hooks.flakeModule inputs.devshell.flakeModule ];
        ...
        in {
          ...
          devshells.default = {
            commands = [
              {
                name = "lint";
                help =
                  "run formatting and linting of haskell and nix files in the entire repository";
            ...
            devshell = {
              name = "cabal-audit";
              packagesFrom =
                [ (import ./nix/haskell-shell.nix { inherit pkgs hspkgs; }) ];
              packages = [ pkgs.cabal2nix pkgs.nixfmt-rfc-style ];
          ...
          packages = {
            ...
            regen-nix = pkgs.writeShellApplication {
              ...
              runtimeInputs = [ pkgs.cabal2nix pkgs.nixfmt-rfc-style ];
              text = ''
                pushd "$PRJ_ROOT"/nix
